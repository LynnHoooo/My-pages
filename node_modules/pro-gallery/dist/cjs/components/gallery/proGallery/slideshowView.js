...
var navigationPanel_1 = tslib_1.__importStar(require("./navigationPanel"));
var virtualization_1 = require("../../helpers/virtualization");
var navigationArrows_js_1 = require("./navigationArrows.js");
var navigationArrowUtils_js_1 = require("../../helpers/navigationArrowUtils.js");
...
var SlideshowView = /** @class */ (function (_super) {
    ...
    function SlideshowView(props) {
        ...
        _this.autoScrollToNextItem = function () {
            if (!pro_gallery_lib_1.isEditMode() && (_this.props.isInViewport || pro_gallery_lib_1.isPreviewMode())) {
                ...
                else if (options.autoSlideshowType === pro_gallery_lib_1.GALLERY_CONSTS.autoSlideshowTypes.INTERVAL) {
                    _this._next({
                        direction: direction,
                        isAutoTrigger: true,
                        scrollDuration: 800,
            ...
            return (_this.navigationPanelAPI ||
                (_this.navigationPanelAPI = {
                    ...
                    triggerItemAction: function (e, _a) {
                        var _b = _a === void 0 ? {} : _a, _c = _b.itemIndex, itemIndex = _c === void 0 ? _this.state.activeIndex : _c;
                        ...
                        var props = item === null || item === void 0 ? void 0 : item.renderProps(tslib_1.__assign(tslib_1.__assign({}, galleryConfig), { visible: true }));
                        _this.props.actions.eventsListener(pro_gallery_lib_1.GALLERY_CONSTS.events.ITEM_ACTION_TRIGGERED, props, e);
                    },
                    // nextGroup,
                    // previousItem,
                    // previousGroup,
                    toIndex: function (itemIdx) {
                        return _this.scrollToIndex({ itemIdx: itemIdx, scrollDuration: 400 });
                    },
    ...
    SlideshowView.prototype.isScrollStart = function () {
        ...
        if (slideAnimation !== pro_gallery_lib_1.GALLERY_CONSTS.slideAnimations.SCROLL ||
            !this.scrollElement) {
            return false;
        }
    ...
    SlideshowView.prototype.onCurrentItemChanged = function () {
        if (this.lastCurrentItem !== this.state.activeIndex) {
            ...
            if (item) {
                ...
                item.resizedImageSrc = currentGalleryItem.createUrl(pro_gallery_lib_1.GALLERY_CONSTS.urlSizes.RESIZED, pro_gallery_lib_1.GALLERY_CONSTS.urlTypes.HIGH_RES);
                this.props.actions.eventsListener(pro_gallery_lib_1.GALLERY_CONSTS.events.CURRENT_ITEM_CHANGED, item);
            }
    ...
    SlideshowView.prototype.scrollToThumbnail = function (itemIdx, scrollDuration) {
        ...
        this.scrollToIndex({ itemIdx: itemIdx, scrollDuration: scrollDuration });
    };
    SlideshowView.prototype.scrollToIndex = function (_a) {
        var itemIdx = _a.itemIdx, scrollDuration = _a.scrollDuration;
        //not to confuse with this.props.actions.scrollToItem. this is used to replace it only for thumbnail items
        this.props.setGotFirstScrollIfNeeded(); //load all the images in the thumbnails bar
        var direction = itemIdx - this.state.activeIndex;
        return this.next({
            direction: direction,
            isAutoTrigger: false,
            scrollDuration: scrollDuration,
    ...
    SlideshowView.prototype.handleSlideshowKeyPress = function (e) {
        ...
        if ((code === 40 && shouldFocusOutOfViewComponent) || code === 27) {
            ...
            pro_gallery_lib_1.utils.focusGalleryElement(elementToFocus);
        }
        else {
    ...
    SlideshowView.prototype.createNavArrows = function () {
        var _a = this.props, container = _a.container, options = _a.options, customComponents = _a.customComponents, id = _a.id;
        var _b = this.state, hideLeftArrow = _b.hideLeftArrow, hideRightArrow = _b.hideRightArrow;
        return (react_1.default.createElement(navigationArrows_js_1.NavigationArrows, { container: container, options: options, customNavArrowsRenderer: customComponents.customNavArrowsRenderer, hideLeftArrow: hideLeftArrow, hideRightArrow: hideRightArrow, next: this._next, id: id }));
    };
    SlideshowView.prototype.getBufferedItems = function (galleryGroups, container) {
        var _a;
        var _b = this, state = _b.state, props = _b.props;
        var options = props.options, virtualizationSettings = props.virtualizationSettings, getVisibleItems = props.getVisibleItems;
        ...
        var galleryWidth = ((_a = this.props.galleryContainerRef) === null || _a === void 0 ? void 0 : _a.clientWidth) ||
            ...
            0;
        return virtualization_1.getItemsInViewportOrMarginByActiveGroup({
            groups: groups,
            activeIndex: activeIndex,
    ...
    SlideshowView.prototype.createLayout = function () {
        var _this = this;
        var _a = this.props, container = _a.container, galleryStructure = _a.galleryStructure;
        ...
        var renderGroups = function (column) {
            ...
            if (layoutGroupView) {
                return layoutGroupView.map(function (_a) {
                    var group = _a.group, shouldRender = _a.shouldRender;
                    return group.rendered
                        ? react_1.default.createElement(groupView_js_1.default, tslib_1.__assign(tslib_1.__assign({ activeIndex: _this.state.activeIndex, slideAnimation: _this.props.options.slideAnimation, allowLoop: _this.props.options.slideshowLoop &&
                                _this.props.galleryStructure.width >
                                    _this.props.container.width }, group.renderProps(galleryConfig)), { ariaHidden: group.idx > _this.skipFromSlide, shouldRenderEmpty: !shouldRender, container: _this.props.container, key: group.idx }))
                        : false;
                });
            }
        };
        return galleryStructure.columns.map(function (column, c) {
            ...
            return (react_1.default.createElement("div", { "data-hook": "gallery-column", id: "gallery-horizontal-scroll-" + _this.props.id, className: "gallery-horizontal-scroll gallery-column hide-scrollbars " + (_this.props.options.isRTL ? ' rtl ' : ' ltr ') + " " + (_this.props.options.scrollSnap ? ' scroll-snap ' : '') + " ", key: 'column' + c, style: columnStyle },
    ...
    SlideshowView.prototype.createGallery = function () {
        ...
        var galleryStyle = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, galleryDimensions), galleryStyleForExternalArrows), mouseCursorContainerStyle);
        return (react_1.default.createElement("div", { id: this.props.galleryContainerId, className: 'pro-gallery inline-styles one-row hide-scrollbars ' +
            ...
            navigationArrowUtils_js_1.shouldRenderNavArrows({
                options: this.props.options,
                container: this.props.container,
                isPrerenderMode: this.props.isPrerenderMode,
    ...
    SlideshowView.prototype.createAutoSlideShowPlayButton = function () {
        ...
        var _a = this.props.options, galleryTextAlign = _a.galleryTextAlign, textBoxHeight = _a.textBoxHeight;
        ...
        return (react_1.default.createElement("button", { className: 'auto-slideshow-button', onClick: function () {
                _this.onAutoSlideShowButtonClick();
            }, onKeyDown: this.onAutoSlideshowAutoPlayKeyPress, "data-hook": "auto-slideshow-button", title: 'slideshow auto play', "aria-pressed": this.state.pauseAutoSlideshowClicked, tabIndex: 0, style: tslib_1.__assign({ top: "calc(100% - " + textBoxHeight + "px + 3px)" }, side) }, this.state.pauseAutoSlideshowClicked ? (react_1.default.createElement(play_1.default, { width: "10px", height: "100%" })) : (react_1.default.createElement(pause_1.default, { width: "10px", height: "100%" }))));
    };
    SlideshowView.prototype.createSlideShowNumbers = function () {
        if (!this.props.options.allowSlideshowCounter) {
            return false;
        }
        var _a = this.props, totalItemsCount = _a.totalItemsCount, _b = _a.options, galleryTextAlign = _b.galleryTextAlign, textBoxHeight = _b.textBoxHeight;
        var imageMargin = this.props.options.imageMargin / 2 + (this.isFullWidthGallery() ? 50 : 0);
        ...
        return (react_1.default.createElement("div", { className: 'auto-slideshow-counter', "data-hook": "auto-slideshow-counter", style: tslib_1.__assign({ top: "calc(100% - " + textBoxHeight + "px + 3px)" }, side) },
            react_1.default.createElement("div", null, (this.state.activeIndex % totalItemsCount) +
                1 +
                '/' +
                totalItemsCount)));
    };
    SlideshowView.prototype.getNavigationPanelArray = function () {
        ...
        if (customNavigationPanelRenderer) {
            var _a = this.props.container, galleryHeight = _a.galleryHeight, galleryWidth = _a.galleryWidth, height = _a.height, width = _a.width;
            ...
            var customNavigationPanelInlineStyles = navigationPanel_1.getCustomNavigationPanelInlineStyles({
            ...
            navigationPanel = (react_1.default.createElement("div", { className: "custom-navigation-panel", style: customNavigationPanelInlineStyles }, customNavigationPanelRenderer(tslib_1.__assign(tslib_1.__assign({}, this.props), { activeIndex: this.state.activeIndex, navigationToIdxCB: this.scrollToThumbnail, navigationPanelAPI: this.createOrGetCustomNavigationPanelAPI() }))));
        }
        else {
            navigationPanel = (react_1.default.createElement(navigationPanel_1.default, tslib_1.__assign({}, this.props, { activeIndex: this.state.activeIndex, navigationToIdxCB: this.scrollToThumbnail })));
        }
        ...
        if (navigationPanelPosition === pro_gallery_lib_1.GALLERY_CONSTS.thumbnailsPosition.ON_GALLERY) {
    ...
    SlideshowView.prototype.getClassNames = function () {
        ...
        if (pro_gallery_lib_1.GALLERY_CONSTS.isLayout('SLIDER')(this.props.options)) {
    ...
    SlideshowView.prototype.componentDidMount = function () {
        this.scrollElement = pro_gallery_lib_1.window.document.querySelector("#pro-gallery-" + this.props.id + " #gallery-horizontal-scroll-" + this.props.id);
