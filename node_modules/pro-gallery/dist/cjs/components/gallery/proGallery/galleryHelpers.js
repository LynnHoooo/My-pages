...
exports.isGalleryInViewport = exports.Deferred = void 0;
...
function isGalleryInViewport(_a) {
    var container = _a.container, scrollTop = _a.scrollTop;
    try {
        var isTopVisible = container.scrollBase < scrollTop + pro_gallery_lib_1.window.innerHeight;
