...
var ScrollIndicator = /** @class */ (function (_super) {
    ...
    ScrollIndicator.prototype.initScrollListener = function () {
        ...
        this.onHorizontalScroll = function (e) {
            ...
            if (left >= 0) {
                if (_this.props.scrollDirection ===
                    ...
                    _this.debouncedOnScroll({ left: left });
                }
            }
        };
        if (this.props.scrollDirection === pro_gallery_lib_1.GALLERY_CONSTS.scrollDirection.HORIZONTAL) {
            try {
                scrollingElement
                    .horizontal()
        ...
        this.onVerticalScroll = function (e) {
            ...
            if (top >= 0) {
                ...
                if (_this.props.scrollDirection === pro_gallery_lib_1.GALLERY_CONSTS.scrollDirection.VERTICAL) {
                    _this.props.getMoreItemsIfNeeded(top);
                }
                _this.debouncedOnScroll({ top: top });
            }
        };
        try {
            scrollingElement
    ...
    ScrollIndicator.prototype.render = function () {
        var verticalScrollBase = this.props.scrollDirection === pro_gallery_lib_1.GALLERY_CONSTS.scrollDirection.VERTICAL &&
            this.props.scrollBase > 0
            ? this.props.scrollBase
            : 0;
        var scrollTopWithoutBase = this.state.scrollTop - verticalScrollBase;
        var id = this.props.id;
        return (react_1.default.createElement("div", { key: "css-scroll-indicator", "data-hook": "css-scroll-indicator", "data-scroll-base": verticalScrollBase, "data-scroll-top": this.state.scrollTop, className: cssScrollHelper_1.cssScrollHelper.calcScrollClasses(id, scrollTopWithoutBase), style: { display: 'none' } }));
    };
