...
var createItemId = function (_a) {
    var galleryId = _a.galleryId, item = _a.item;
    return "#pro-gallery-" + galleryId + " #" + cssScrollHelper_js_1.cssScrollHelper.getSellectorDomId(item);
};
var createExactCssForItems = function (id, galleryItems, styleParams) {
    if (id === void 0) { id = ''; }
    var isRTL = styleParams.isRTL;
    var cssStr = '';
    galleryItems.forEach(function (item) {
        var itemId = createItemId({ galleryId: id, item: item });
...
var createCssLayouts = function (_a) {
    var galleryItems = _a.galleryItems, layoutParams = _a.layoutParams, id = _a.id;
    var exactCss = [];
    exactCss.push(createExactCssForItems(id, galleryItems, layoutParams.styleParams));
    return exactCss;
};
