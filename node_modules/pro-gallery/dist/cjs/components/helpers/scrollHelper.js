...
exports.isWithinPaddingVertically = exports.isWithinPaddingHorizontally = exports.haltScroll = exports.scrollToGroupImp = exports.scrollToItemImp = void 0;
var pro_gallery_lib_1 = require("pro-gallery-lib");
var pro_gallery_lib_2 = require("pro-gallery-lib");
var galleryHelpers_1 = require("../gallery/proGallery/galleryHelpers");
function scrollToItemImp(scrollParams) {
    var to, from;
    var _a = scrollParams.scrollMarginCorrection, scrollMarginCorrection = _a === void 0 ? 0 : _a, durationInMS = scrollParams.durationInMS, horizontalElement = scrollParams.horizontalElement, scrollingElement = scrollParams.scrollingElement, isRTL = scrollParams.isRTL, scrollDirection = scrollParams.scrollDirection, galleryWidth = scrollParams.galleryWidth, galleryHeight = scrollParams.galleryHeight, totalWidth = scrollParams.totalWidth, top = scrollParams.top, items = scrollParams.items, itemIdx = scrollParams.itemIdx, fixedScroll = scrollParams.fixedScroll, slideTransition = scrollParams.slideTransition, isContinuousScrolling = scrollParams.isContinuousScrolling, autoSlideshowContinuousSpeed = scrollParams.autoSlideshowContinuousSpeed, imageMargin = scrollParams.imageMargin;
    var rtlFix = isRTL ? -1 : 1;
    //default = scroll by half the container size
    if (scrollDirection === pro_gallery_lib_2.GALLERY_CONSTS.scrollDirection.HORIZONTAL) {
    ...
    if (fixedScroll !== true) {
        ...
        to =
            scrollDirection === pro_gallery_lib_2.GALLERY_CONSTS.scrollDirection.HORIZONTAL
...
function scrollToGroupImp(scrollParams) {
    var to, from;
    var _a = scrollParams.scrollMarginCorrection, scrollMarginCorrection = _a === void 0 ? 0 : _a, durationInMS = scrollParams.durationInMS, horizontalElement = scrollParams.horizontalElement, scrollingElement = scrollParams.scrollingElement, isRTL = scrollParams.isRTL, scrollDirection = scrollParams.scrollDirection, galleryWidth = scrollParams.galleryWidth, galleryHeight = scrollParams.galleryHeight, totalWidth = scrollParams.totalWidth, top = scrollParams.top, groups = scrollParams.groups, groupIdx = scrollParams.groupIdx, fixedScroll = scrollParams.fixedScroll, slideTransition = scrollParams.slideTransition, isContinuousScrolling = scrollParams.isContinuousScrolling, autoSlideshowContinuousSpeed = scrollParams.autoSlideshowContinuousSpeed, imageMargin = scrollParams.imageMargin;
    var rtlFix = isRTL ? -1 : 1;
    //default = scroll by half the container size
    if (scrollDirection === pro_gallery_lib_2.GALLERY_CONSTS.scrollDirection.HORIZONTAL) {
    ...
    if (fixedScroll !== true) {
        ...
        to =
            scrollDirection === pro_gallery_lib_2.GALLERY_CONSTS.scrollDirection.HORIZONTAL
                ? pro_gallery_lib_1.utils.get(group, 'left')
                : pro_gallery_lib_1.utils.get(group, 'top');
        if (pro_gallery_lib_1.utils.isVerbose()) {
...
function horizontalCssScrollTo(_a) {
    var scroller = _a.scroller, from = _a.from, to = _a.to, duration = _a.duration, isRTL = _a.isRTL, slideTransition = _a.slideTransition, isContinuousScrolling = _a.isContinuousScrolling, autoSlideshowContinuousSpeed = _a.autoSlideshowContinuousSpeed;
    var change = to - from;
    if (change === 0) {
    ...
    var scrollDeffered = new galleryHelpers_1.Deferred();
...
function animateStopScroll(_a) {
    var scroller = _a.scroller, at = _a.at, isRTL = _a.isRTL;
    Object.assign(scroller.style, {
        'scroll-snap-type': 'none',
    });
    var scrollDeffered = new galleryHelpers_1.Deferred();
...
function haltScroll(_a) {
    var scroller = _a.scroller, from = _a.from, isRTL = _a.isRTL, currentScrollEndTimeout = _a.currentScrollEndTimeout, scrollDeffered = _a.scrollDeffered;
