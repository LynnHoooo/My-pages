...
var VideoScrollHelper = /** @class */ (function () {
    ...
    VideoScrollHelper.prototype.updateGalleryStructure = function (_a) {
        var _this = this;
        var galleryStructure = _a.galleryStructure, galleryWidth = _a.galleryWidth, scrollBase = _a.scrollBase, videoPlay = _a.videoPlay, videoLoop = _a.videoLoop, itemClick = _a.itemClick, scrollDirection = _a.scrollDirection;
    ...
    VideoScrollHelper.prototype.handleEvent = function (_a) {
        ...
        switch (eventName) {
            ...
            case pro_gallery_lib_1.GALLERY_CONSTS.events.ITEM_ACTION_TRIGGERED:
                ...
                break;
            case pro_gallery_lib_1.GALLERY_CONSTS.events.VIDEO_PAUSED:
    ...
    VideoScrollHelper.prototype.isVisible = function (item, _a) {
        ...
        if (this.scrollDirection === pro_gallery_lib_1.GALLERY_CONSTS.scrollDirection.VERTICAL) {
