...
var CssScrollHelper = /** @class */ (function () {
    ...
    CssScrollHelper.prototype.calcScrollCss = function (_a) {
        ...
        this.screenSize =
            options.scrollDirection === pro_gallery_lib_1.GALLERY_CONSTS.scrollDirection.HORIZONTAL
        ...
        if (options.scrollDirection === pro_gallery_lib_1.GALLERY_CONSTS.scrollDirection.VERTICAL &&
        ...
        this.maxHeight =
            (Math.ceil(((options.scrollDirection === pro_gallery_lib_1.GALLERY_CONSTS.scrollDirection.HORIZONTAL
                ? right
                : top) +
                this.screenSize) /
                maxStep) +
        ...
        var cssScroll = items.map(function (item) {
            return _this.calcScrollCssForItem({ id: id, item: item, options: options });
        });
    ...
    CssScrollHelper.prototype.createScrollSelectorsFunction = function (_a) {
        var _this = this;
        var id = _a.id, item = _a.item, options = _a.options;
        var imageTop = options.scrollDirection === pro_gallery_lib_1.GALLERY_CONSTS.scrollDirection.HORIZONTAL
            ? item.offset.left - this.screenSize
            : item.offset.top - this.screenSize;
        var imageBottom = options.scrollDirection === pro_gallery_lib_1.GALLERY_CONSTS.scrollDirection.HORIZONTAL
    ...
    CssScrollHelper.prototype.createScrollAnimationsIfNeeded = function (_a) {
        var idx = _a.idx, options = _a.options, createScrollSelectors = _a.createScrollSelectors;
        var isRTL = options.isRTL, scrollDirection = options.scrollDirection, scrollAnimation = options.scrollAnimation;
        if (!scrollAnimation ||
            scrollAnimation === pro_gallery_lib_1.GALLERY_CONSTS.scrollAnimations.NO_EFFECT) {
            return '';
        }
        ...
        if (scrollAnimation === pro_gallery_lib_1.GALLERY_CONSTS.scrollAnimations.SLIDE_UP) {
            var axis = scrollDirection === pro_gallery_lib_1.GALLERY_CONSTS.scrollDirection.HORIZONTAL
                ? 'X'
                : 'Y';
            var direction = isRTL ? '-' : '';
            scrollAnimationCss +=
