...
var ItemHover = /** @class */ (function (_super) {
    ...
    ItemHover.prototype.getHoverClass = function () {
        var _a = this.props, options = _a.options, forceShowHover = _a.forceShowHover;
    ...
    ItemHover.prototype.shouldRenderHoverInnerIfExist = function () {
        var _a = this.props, itemWasHovered = _a.itemWasHovered, options = _a.options;
        var hoveringBehaviour = options.hoveringBehaviour, overlayAnimation = options.overlayAnimation, alwaysShowHover = options.alwaysShowHover, previewHover = options.previewHover;
    ...
    ItemHover.prototype.getOverlayStyle = function () {
        var _a = this.props, options = _a.options, imageDimensions = _a.imageDimensions;
        var style = {};
        var overlayPosition = options.overlayPosition, requiredOverlaySize = options.overlaySize, overlaySizeType = options.overlaySizeType, overlayPadding = options.overlayPadding;
        var isHorizontal = overlayPosition === pro_gallery_lib_1.GALLERY_CONSTS.overlayPositions.LEFT ||
            overlayPosition === pro_gallery_lib_1.GALLERY_CONSTS.overlayPositions.RIGHT ||
            overlayPosition === pro_gallery_lib_1.GALLERY_CONSTS.overlayPositions.CENTERED_HORIZONTALLY;
    ...
    ItemHover.prototype.calcHeightAndWidth = function (_a) {
        var _b;
        var isHorizontal = _a.isHorizontal, overlayPadding = _a.overlayPadding, requiredOverlaySize = _a.requiredOverlaySize, imageDimensions = _a.imageDimensions, overlaySizeType = _a.overlaySizeType;
    ...
    ItemHover.prototype.getOverlayPositionByFlex = function () {
        ...
        var width = imageDimensions.width, height = imageDimensions.height, marginTop = imageDimensions.marginTop, marginLeft = imageDimensions.marginLeft;
        var style = {
            width: width,
            height: height,
            marginTop: marginTop,
        ...
        switch (overlayPosition) {
            case pro_gallery_lib_1.GALLERY_CONSTS.overlayPositions.RIGHT:
                Object.assign(style, {
                    justifyContent: 'flex-end',
                });
                break;
            case pro_gallery_lib_1.GALLERY_CONSTS.overlayPositions.BOTTOM:
                Object.assign(style, {
                    alignItems: 'flex-end',
                });
                break;
            case pro_gallery_lib_1.GALLERY_CONSTS.overlayPositions.CENTERED_HORIZONTALLY:
                Object.assign(style, {
                    justifyContent: 'center',
                });
                break;
            case pro_gallery_lib_1.GALLERY_CONSTS.overlayPositions.CENTERED_VERTICALLY:
                Object.assign(style, {
                    alignItems: 'center',
                });
                break;
    ...
    ItemHover.prototype.render = function () {
        var _a = this.props, actions = _a.actions, idx = _a.idx, renderCustomInfo = _a.renderCustomInfo;
