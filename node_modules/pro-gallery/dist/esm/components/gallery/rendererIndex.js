...
var GalleryRenderer = /** @class */ (function (_super) {
    ...
    GalleryRenderer.prototype.render = function () {
        var _a = this.props, id = _a.id, options = _a.options, eventsListener = _a.eventsListener, customComponents = _a.customComponents, otherProps = __rest(_a, ["id", "options", "eventsListener", "customComponents"]);
        ...
        var galleryRendererProps = __assign(__assign({}, otherProps), { options: _options, eventsListener: _eventsListener, id: id || 'default-dom-id', customComponents: customComponents || {} });
