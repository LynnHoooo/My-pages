...
var ScrollIndicator = /** @class */ (function (_super) {
    ...
    ScrollIndicator.prototype.render = function () {
        ...
        return (React.createElement("div", { key: "css-scroll-indicator", "data-hook": "css-scroll-indicator", "data-scroll-base": verticalScrollBase, "data-scroll-top": this.state.scrollTop, className: cssScrollHelper.calcScrollClasses(id, scrollTopWithoutBase), style: { display: 'none' } }));
    };
