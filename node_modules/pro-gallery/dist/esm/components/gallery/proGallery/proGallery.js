...
var ProGallery = /** @class */ (function (_super) {
    ...
    ProGallery.prototype.renderProps = function () {
        var _a;
        return __assign(__assign({}, this.props), { id: this.props.id, items: this.props.items || [], settings: this.props.settings || {}, offsetTop: this.props.offsetTop, proGalleryRegionLabel: this.props.proGalleryRegionLabel, isInDisplay: (_a = this.props.isInDisplay) !== null && _a !== void 0 ? _a : true });
    };
