...
declare class GalleryItem {
    ...
    createMagnifiedUrl(scale?: number): any;
    createSecondMediaItemIfNeeded(config: any): void;
    secondaryMediaItem: GalleryItem | undefined;
    updateSecondaryMedia(config: any): void;
    mapItemConfig(config: any): any;
    ...
    id: any;
    idx: any;
    set type(arg: "dummy" | "video" | "text" | "image");
    get type(): "dummy" | "video" | "text" | "image";
    style: any;
    width: any;
    maxWidth: any;
    infoWidth: any;
    ...
    processedMediaUrl(resizeMethod: any, requiredWidth: any, requiredHeight: any, sharpParams: any, createMultipleUrls?: boolean): any;
    resetUrls(): void;
