...
var galleryItem_1 = tslib_1.__importDefault(require("./galleryItem"));
var galleryGroup_1 = tslib_1.__importDefault(require("./galleryGroup"));
    ...
    ItemsHelper.convertDtoToLayoutItem = function (dto) {
        ...
        if (isLayoutItem) {
            ...
            var metadata = typeof dtoMetadata === 'object'
                ? dtoMetadata
                : pro_gallery_lib_1.utils.parseStringObject(dtoMetadata) || {};
            return tslib_1.__assign({ id: dto.itemId || dto.photoId, width: metadata.width, height: metadata.height }, dto);
        }
    };
        ...
        for (var c = 0; c < galleryStructure.columns.length; c++) {
            ...
            for (var g = 0; g < groups.length; g++) {
                ...
                for (var i = 0; i < group.items.length; i++) {
                    ...
                    var _itemConfig = tslib_1.__assign({ scheme: item, dto: item.dto }, itemConfig);
                    ...
                    if (existingItem && existingItem.id && existingItem.id === item.id) {
                        ...
                        newItem = new galleryItem_1.default(_itemConfig);
                    }
                    groupItems[i] = newItem;
                    galleryStructure.galleryItems[item.idx] = groupItems[i];
                }
                column.galleryGroups[g] = new galleryGroup_1.default({
                    scheme: group,
                    dto: group.dto,
                    items: groupItems,
                });
            ...
            for (var g = 0; g < groups.length; g++) {
                ...
                for (var i = 0; i < group.items.length; i++) {
                    ...
                    if (!existingStructure.galleryItems[item.idx]) {
                        ...
                        groupItems[i] = new galleryItem_1.default(Object.assign({
                            scheme: item,
                            dto: item.dto,
                        }, itemConfig));
                ...
                if (!existingColumn.galleryGroups[g]) {
                    ...
                    existingColumn.galleryGroups[g] = new galleryGroup_1.default({
                        scheme: group,
                        dto: group.dto,
                        items: groupItems,
                    });
