...
var strip_js_1 = require("./strip.js");
var column_js_1 = require("./column.js");
var layoutsStore_js_1 = tslib_1.__importDefault(require("./layoutsStore.js"));
var Layouter = /** @class */ (function () {
    ...
    Layouter.prototype.updateParams = function (layoutParams) {
        ...
        this.styleParams = utils_1.utils.addDefaultStyleParams(layoutParams.styleParams);
        this.container = utils_1.utils.convertContainer(layoutParams.container, this.styleParams);
    ...
    Layouter.prototype.saveExistingLayout = function () {
        if (this.useLayoutStore) {
            layoutsStore_js_1.default.layout = {
    ...
    Layouter.prototype.prepareLayoutParams = function () {
        ...
        if (this.useExistingLayout && this.pointer > 0) {
            if (this.useLayoutStore) {
                Object.assign(this, layoutsStore_js_1.default.layout);
            }
            else {
                if (this.styleParams.isVertical) {
                    //---------------------| COLUMNS GALLERY |----------------------//
                    ...
                    if (this.scrollDirection === 1) {
                        ...
                        if (lastStrips) {
                            ...
                            this.strip = new strip_js_1.Strip({
            ...
            this.columns = Array(this.numOfCols)
                ...
                return new column_js_1.Column(idx, colWidth, curLeft, fixedCubeHeight_1, infoWidth);
            });
            this.maxLoops = this.srcItems.length * 10;
        }
    };
    Layouter.prototype.createLayout = function (layoutParams) {
        ...
        while (this.srcItems[this.pointer]) {
            ...
            this.group = new group_js_1.Group({
                idx: this.groupIdx,
