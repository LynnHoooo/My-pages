...
var Item = /** @class */ (function () {
    ...
    Item.prototype.calcScatter = function (offset) {
        ...
        if (this.rotatingScatter.length > 0) {
            ...
            var horizontalShift = utils_1.utils.hashToRandomInt(this.seed + offset.right + 'x', -spaceLeft, spaceRight);
            ...
            var verticalShift = utils_1.utils.hashToRandomInt(this.seed + offset.right + 'y', -spaceUp, spaceDown);
    ...
    Object.defineProperty(Item.prototype, "seed", {
        get: function () {
            return this.dto.seed || utils_1.utils.hashToInt(this.hash);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(Item.prototype, "roundedStyle", {
        get: function () {
            return tslib_1.__assign(tslib_1.__assign({}, this.style), { width: Math.round(this.style.width), height: Math.round(this.style.height) });
        },
        enumerable: false,
        configurable: true
    });
