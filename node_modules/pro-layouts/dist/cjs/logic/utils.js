...
var Utils = /** @class */ (function () {
    ...
    Utils.prototype.addDefaultStyleParams = function (styleParams) {
        function populateWithDefaultOptions(options) {
            ...
            var flatDefault = pro_gallery_lib_1.flattenObject(defaultLayouterSP);
            var flatOptions = pro_gallery_lib_1.flattenObject(options);
            ...
            return pro_gallery_lib_1.flatToNested(mergedOptions);
        }
        //default styleParams
        ...
        var fullMigratedAndOld = pro_gallery_lib_1.extendNestedOptionsToIncludeOldAndNew(styleParams);
        var populatedWithDefault = populateWithDefaultOptions(fullMigratedAndOld);
        return pro_gallery_lib_1.extendNestedOptionsToIncludeOldAndNew(populatedWithDefault);
    };
    Utils.prototype.convertContainer = function (container, styleParams) {
        var convertedContainer = tslib_1.__assign({ bounds: {} }, container);
