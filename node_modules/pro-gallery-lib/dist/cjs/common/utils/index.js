...
var lodash = tslib_1.__importStar(require("./lodash"));
var windowWrapper_1 = tslib_1.__importDefault(require("../window/windowWrapper"));
var viewModeWrapper_1 = require("../window/viewModeWrapper");
...
var Utils = /** @class */ (function () {
    ...
    Utils.prototype.shouldUseCache = function () {
        return !viewModeWrapper_1.isEditMode() && !viewModeWrapper_1.isPreviewMode() && !this.isSSR();
    };
    ...
    Utils.prototype.isMobileByProps = function () {
        ...
        var _isMobileByProps = function () {
            var deviceType = _this.parseGetParam('deviceType') || windowWrapper_1.default.deviceType;
            var isMobileViewer = _this.parseGetParam('showMobileView') === 'true';
            var deviceTypeMobile = viewModeWrapper_1.isDeviceTypeMobile();
            if (isMobileViewer) {
                return true;
            }
            else if (deviceType) {
    ...
    Utils.prototype.isUserAgentMobile = function () {
        try {
            var _isUserAgentMobile = function () {
                ...
                })(navigator.userAgent || navigator.vendor || windowWrapper_1.default.opera);
                return check;
            };
    ...
    Utils.prototype.isTest = function () {
        try {
            return windowWrapper_1.default.isTest;
        }
        catch (e) {
            return false;
        }
    ...
    Utils.prototype.isLocal = function () {
        try {
            var host = windowWrapper_1.default.location.hostname;
    ...
    Utils.prototype.isStoreGallery = function () {
        ...
        return this.getOrPutFromCache('isStoreGallery', function () {
            try {
                return windowWrapper_1.default.location.search.toLowerCase().indexOf('isstore') > -1;
            }
            catch (e) {
                if (_this.isDev()) {
    ...
    Utils.prototype.isiOS = function () {
        return this.getOrPutFromCache('isiOS', function () {
            try {
                return /iPad|iPhone|iPod/.test(navigator.userAgent) && !windowWrapper_1.default.MSStream;
            }
            catch (e) {
                return false;
            }
    ...
    Utils.prototype.isiPhone = function () {
        return this.getOrPutFromCache('isiPhone', function () {
            try {
                return /iPhone/.test(navigator.userAgent) && !windowWrapper_1.default.MSStream;
            }
            catch (e) {
                return false;
            }
    ...
    Utils.prototype.isLandscape = function () {
        ...
        return this.getOrPutFromCache('isLandscape', function () {
            ...
            try {
                if (!_this.isUndefined(windowWrapper_1.default.orientation)) {
                    return windowWrapper_1.default.orientation === 90 || windowWrapper_1.default.orientation === -90;
                }
                else {
                    var mql = windowWrapper_1.default.matchMedia('(orientation: landscape)');
    ...
    Utils.prototype.safeLocalStorage = function () {
        try {
            return localStorage ? localStorage : windowWrapper_1.default; // TrackJS errors, function returning null
        }
        catch (e) {
            return windowWrapper_1.default;
        }
    };
    Utils.prototype.shouldDebug = function (str) {
        try {
            return (!!this.safeLocalStorage()[str] ||
                (windowWrapper_1.default.debugApp || '').indexOf(str) >= 0 ||
    ...
    Utils.prototype.setStateAndLog = function (that, caller, state, callback) {
        ...
        if (this.isVerbose()) {
            ...
            var oldState_1 = tslib_1.__assign({}, that.state);
            that.setState(state, function () {
                var newState = tslib_1.__assign({}, that.state);
    ...
    Utils.prototype.getScreenWidth = function () {
        if (viewModeWrapper_1.isPreviewMode() && this.isMobile()) {
        ...
        try {
            if (this.isLandscape()) {
                return Math.max(windowWrapper_1.default.screen.width, windowWrapper_1.default.screen.height);
            }
            else {
                return windowWrapper_1.default.screen.width;
            }
        }
        catch (e) {
            return 1920;
    ...
    Utils.prototype.getScreenHeight = function () {
        ...
        try {
            if (this.isLandscape()) {
                return Math.min(windowWrapper_1.default.screen.width, windowWrapper_1.default.screen.height);
            }
            else {
                return windowWrapper_1.default.screen.height;
            }
        }
        catch (e) {
            return 1200;
    ...
    Utils.prototype.getWindowWidth = function () {
        try {
            return windowWrapper_1.default.innerWidth || 980;
        }
        catch (e) {
            return 980;
        }
    ...
    Utils.prototype.isSingleItemHorizontalDisplay = function (options) {
        return (options.scrollDirection === constants_1.default.scrollDirection.HORIZONTAL &&
            options.groupSize === 1 &&
            options.cubeImages &&
