...
exports.default = {
    ...
    isRelevant: function (options, option) {
        ...
        var isVerticalInfoCompatibleLayout = function (options) {
            return {
        ...
        return option
            ...
            : Object.values(placementOptions).some(function (val) { return val(options); });
    },
    type: constants_1.INPUT_TYPES.MULTISELECT,
    default: constants_2.default.placements.SHOW_ON_HOVER,
    options: utils_1.createOptions('placements'),
...
//# sourceMappingURL=titlePlacement.js.map