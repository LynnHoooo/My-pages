...
var layoutParams_structure_galleryRatio_includeExternalInfo_1 = tslib_1.__importDefault(require("../../settings/options/layoutParams_structure_galleryRatio_includeExternalInfo"));
        ...
        return this.getOrPutInCache('galleryDimensions', function () {
            ...
            if (_this.options.hasThumbnails &&
                _this.options.layoutParams.thumbnails.position ===
                    index_1.default.thumbnailsPosition.OUTSIDE_GALLERY) {
    ...
    DimensionsHelper.prototype.getGalleryWidth = function () {
        ...
        return this.getOrPutInCache('galleryWidth', function () {
            ...
            if (_this.options.arrowsPosition ===
                index_1.default.arrowsPosition.OUTSIDE_GALLERY &&
                _this.options.scrollDirection ===
                    index_1.default.scrollDirection.HORIZONTAL) {
                width -=
        ...
        if (this.options.scrollDirection ===
            ...
            if (this.options.hasThumbnails &&
                ...
                if (!this.options.layoutParams.structure.galleryRatio
                    .includeExternalInfo &&
                    layoutParams_structure_galleryRatio_includeExternalInfo_1.default.isRelevant(this.options)) {
...
exports.default = new DimensionsHelper();
