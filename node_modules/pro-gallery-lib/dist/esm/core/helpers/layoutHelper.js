...
import PLACEMENTS, { hasExternalVerticalPlacement, hasHoverPlacement, isConstantVerticalPlacement, isHoverPlacement, } from '../../common/constants/placements';
...
var centerArrowsWhenNeeded = function (options) {
    ...
    var filteredPlacement = _options.titlePlacement // filtering hover since it doesn't affect this product
        .split(',')
        .filter(function (placement) { return !isHoverPlacement(placement); })
        .join(',');
